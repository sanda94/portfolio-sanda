...
export const HERO_CONTENT = `I am a passionate full stack developer with a knack for crafting robust and scalable web applications. With 5 years of Sri Lanka And 1 year Of Singapore hands-on experience, I have honed my skills in front-end technologies like React and Next.js, as well as back-end technologies like Node.js, MySQL, PostgreSQL, and MongoDB. My goal is to leverage my expertise to create innovative solutions that drive business growth and deliver exceptional user experiences.`;
...
export const EXPERIENCES = [
  {
    ...
    technologies: ["Javascript", "React.js", "Next.js", "mongoDB",   "React Native"],
  },
  {
    year: "2017 - 2019",
    role: "Full Stack Developer",
    company: "EXTREME IT SOLUTIONS PTE LTD, SRI LANKA",
...
export const PROJECTS = [
  ...
  {
    title: "NOSQL DATABASE BASED ON PSB ACADEMY'S OPERATION THE FINAL PROJECT OF THE BIG DATA MODULE",
    image: project3,
    description:
      "Cloud database and the step-by-step to create a database 5 collections, 5 Constraints Cloud storage and the step-by-step to create storage for Validation Rule",
    technologies: ["Mongo DB", "React JS", "React", "Bootstrap"],
  },
  {
